...
(function () {
  ...
  var SEED = [
    { id: 'seed-westa', name_uk: 'WESTA', name_en: 'WESTA', category: 'Commercial', year: '2024',
      ...
      video_url: 'https://vimeo.com/1045734109', thumb: 'includes/img/works4/westa.png',
    ...
    { id: 'seed-golden', name_uk: 'Готель «Золотий пляж»', name_en: 'Golden Beach Hotel', category: 'Commercial', year: '2024',
      ...
      video_url: 'https://vimeo.com/1045745423', thumb: 'includes/img/works4/golden_beach.png',
    ...
    { id: 'seed-lol', name_uk: 'L.O.L + KIDDISVIT', name_en: 'L.O.L + KIDDISVIT', category: 'Social Content', year: '2022',
      ...
      video_url: 'https://vimeo.com/656145490', thumb: 'includes/img/works/lol_kiddisvit.jpg',
    ...
    { id: 'seed-tsina', name_uk: 'Ціна питання', name_en: 'The Price of the Question', category: 'Podcasts', year: '2024',
      ...
      video_url: 'https://vimeo.com/693969376', thumb: 'includes/img/works/back1.jpg',
    ...
    { id: 'seed-yaktak', name_uk: 'YAKTAK', name_en: 'YAKTAK', category: 'YouTube', year: '2023',
      ...
      video_url: 'https://vimeo.com/784082737', thumb: 'includes/img/works/sw.jpg',
    ...
    { id: 'seed-snow', name_uk: 'На новий рік обіцяють сніг', name_en: 'Snow is promised for New Year', category: 'Documentary', year: '2022',
      ...
      video_url: 'https://vimeo.com/663735486', thumb: 'includes/img/works/new_year_2021.jpg',
    ...
    { id: 'seed-vitals', name_uk: 'VITALS', name_en: 'VITALS', category: 'Commercial', year: '2021',
      ...
      video_url: 'https://vimeo.com/538309611', thumb: 'includes/img/works/vitals.jpg',
    ...
    { id: 'seed-veladis', name_uk: 'VELADIS', name_en: 'VELADIS', category: 'Social Content', year: '2021',
      ...
      video_url: 'https://vimeo.com/534356018', thumb: 'includes/img/works/veladis_kozak.jpg',
  ...
  // Іконки для карток послуг (кілька преміальних SVG, циклічно за індексом).
  var SERVICE_ICONS = [
  ...
  function renderServicesCards() {
    ...
    box.innerHTML = SITE_SERVICES.map(function (s, i) {
